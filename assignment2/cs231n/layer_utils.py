...
def affine_bn_relu_forward(x, w, b, gamma, beta, bn_param):
  ...
  return a3, (fc_cache, bn_cache, relu_cache)
...
def affine_relu_drop_forward(x, w, b, dropout_param):
  ...
  a3, drop_cache = dropout_forward(a2, dropout_param)
  return a3, (fc_cache, relu_cache, drop_cache)


def affine_relu_drop_backward(dout, cache):
  fc_cache, relu_cache, drop_cache = cache
  da2 = dropout_backward(dout, drop_cache)
